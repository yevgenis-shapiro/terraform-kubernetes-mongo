...
![1_ZA5fmcFjt25p0nBxKgULtA](https://github.com/user-attachments/assets/6737c691-81d9-42c2-ab17-e08ee1b0636d)
...
```
- Refer [AWS examples](https://github.com/yevgenis-shapiro/terraform-kubernetes-mongodb/tree/main/examples/complete/aws) for more details.
- Refer [Azure examples](https://github.com/yevgenis-shapiro/terraform-kubernetes-mongodb/tree/main/examples/complete/azure) for more details.
- Refer [GCP examples](https://github.com/yevgenis-shapiro/terraform-kubernetes-mongodb/tree/main/examples/complete/gcp) for more details.
